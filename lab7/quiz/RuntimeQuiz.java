...
public class RuntimeQuiz {
     ...
     */
    public static Runtime f1_omega_runtime = QUADRATIC;
    public static Runtime f1_o_runtime = LINEAR;
    public static Runtime f1_theta_runtime = LINEARITHMIC;
    ...
    public static Runtime f2_omega_runtime = EXPONENTIAL;
    public static Runtime f2_o_runtime = LINEAR;
    public static Runtime f2_theta_runtime = QUADRATIC;
    public int f2(int n) {
        if (n <= 1) return n;
        f1(new int[n]);
    ...
    public static Runtime f3_omega_runtime = LINEARITHMIC;
    public static Runtime f3_o_runtime = CONSTANT;
    public static Runtime f3_theta_runtime = LINEAR;
    ...
    public static Runtime f4_omega_runtime = QUADRATIC;
    public static Runtime f4_o_runtime = LINEAR;
    public static Runtime f4_theta_runtime = LINEARITHMIC;
    ...
    public static Runtime f5_omega_runtime = LINEAR;
    public static Runtime f5_o_runtime = CONSTANT ;
    public static Runtime f5_theta_runtime = LOG_N;
    ...
    public static Runtime f6_omega_runtime = LINEAR;
    public static Runtime f6_o_runtime = CONSTANT;
    public static Runtime f6_theta_runtime = LOG_N;
    ...
    public static Runtime f7_omega_runtime = UNDEFINED;
    public static Runtime f7_o_runtime = EXPONENTIAL;
    public static Runtime f7_theta_runtime = UNDEFINED;
